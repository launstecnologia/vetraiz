                ...
                <div class="swiper-wrapper ha-slider-wrapper">
                    ...
                    ?>
                            <div class="swiper-slide ha-slider-slide elementor-repeater-item-<?php echo $slide['_id']; ?>">
								...
								$slide_content_template = apply_filters('wpml_object_id', $slide['slide_content_template'], 'elementor_library');
                                    echo ha_elementor()->frontend->get_builder_content_for_display($slide_content_template);
